            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted leading-relaxed">
                  ...
                  <p>
                    Ми віримо, що українське мистецтво має унікальну силу об&apos;єднувати 
                    людей, зберігати культурну пам&apos;ять та надихати нові покоління митців.
                  </p>
                  <p>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="bg-background rounded-2xl p-8 md:p-12">
                ...
                <p className="text-muted leading-relaxed mb-6">
                  «Ми хочемо відкрити світу нові імена українських художників і дати їм 
                  можливість повноцінно працювати над своєю творчістю. Українське народне 
                  мистецтво — це наша спадщина, яку ми маємо зберігати та розвивати.»
                </p>
