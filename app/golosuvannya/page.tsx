...
export default function VotingPage() {
  ...
  const handleVote = async () => {
    ...
    if (hasCyrillic) {
      ...
      setErrorMessage("Email не може містити кириличні (російські/українські) літери.")
      return
    }
    ...
    if (!isValidEmail) {
      setSubmitStatus("error")
      setErrorMessage("Будь ласка, введіть коректний email (наприклад: name@gmail.com).")
      return
    }
