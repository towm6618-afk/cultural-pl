      ...
      <main className="pt-24 pb-24 bg-background">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose-lg">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-16">
              Під час експозиції тривав другий етап конкурсу — народне голосування. За час проведення виставку відвідали понад 2000 гостей, а більш ніж 30000 осіб долучилися до онлайн-голосування.
            </p>
