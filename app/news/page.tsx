...
const posts = [
  {
    slug: "vistavka-naoma",
    category: "Переможці",
    title: "Оголосили переможців Першого національного конкурсу народного мистецтва для молодих художників «Поліська казка»",
    excerpt: "23 квітня 2026 року в Національній академії образотворчого мистецтва і архітектури відбулася урочиста церемонія оголошення та нагородження переможців Першого національного конкурсу народного мистецтва для молодих художників «Поліська казка», заснованого Всеукраїнською культурною платформою «Поліська казка» у партнерстві з НАОМА.",
    date: "19 березня 2026",
    image: "https://i.ibb.co/yc2mR990/IMG-7860.webp",
  },
  {
    slug: "vistavka-naoma",
    category: "Виставка",
    title: "У Києві відкрилася виставка народного мистецтва: Марія Примаченко та фіналісти конкурсу “Поліська Казка”",
    excerpt: "Виставка народного мистецтва: Марія Примаченко та фіналісти конкурсу “Поліська Казка”, що об’єднує роботи легендарної художниці та сучасних митців, відкрилася 19 березня 2026 року в Національній академії образотворчого мистецтва і архітектури",
    date: "19 березня 2026",
    image: "https://i.ibb.co/Z4vRnPJ/vistavka-naoma.webp",
  },
  {
    ...
    date: "14 лютого 2026",
    image: "https://i.ibb.co/zWJkT0SW/IMG-3542.webp",
  },
  {
    ...
    date: "3 лютого 2026",
    image: "https://i.ibb.co/GfJDW86D/IMG-3541.webp",
  },
  {
    slug: "konkurs",
    category: "Анонс",
    ...
    date: "22 грудня 2025",
    image: "https://i.ibb.co/kgb0ZSRg/IMG-3543.webp",
  },
]
